...
(If you don't have [deno](https://deno.com/), uncomment the two `# debug: no * minification` blocks in `Makefile`.)
...
I made the pages' images and all the other data available for any project needing them at:
